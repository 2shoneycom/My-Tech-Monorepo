...
const zustandImg1 = "/images/zustand_vs_props_comparison.png";
        ...
        <div class="Enhancement-item">
          <figure class="Figure">
            <div class="Figure-media">
              <picture>
                <img class="Image" data-image-size="figureLarge" alt="zustandImg1.png" src=${zustandImg1}>
              </picture>
            </div>
...
function useAuthStore(selector) {
  ...
  // Vite가 뭐길래
  {
    ...
    tag: ["Web", "Frontend", "React", "DevTool"],
    title: "Vite가 뭐길래",
